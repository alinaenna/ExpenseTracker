...
const StatsInfoCard = ({ icon, label, value, color }) => {
    return <div className="flex gap-6 bg-white p-4 rounded-xl shdow-md shadow-blue-400/10 border border-gray-200/50 z-10">
        <div
        ...
        <div>
            ...
            <span className="text-[20px]">MYR {value}</span>
        </div>
    </div>
}
